        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-header">EDIT POST <router-link :to="{ name: 'posts' }" class="btn btn-sm btn-success">Back</router-link></div>
                    <div class="card-body">
                        <form @submit.prevent="PostUpdate" >
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                 <label>KONTEN</label>
                                 <textarea class="form-control" v-model="post.content" placeholder="Masukan Konten"></textarea>
